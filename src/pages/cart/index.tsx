	...
	return (
		<div className="h-screen bg-bgGray ">
			...
			<div className="w-screen bg-white  ">
				<div>
					<Header />
					<div className="flex h-[48px] w-[768px] m-auto top-0 left-0 justify-between items-center">
						<div className="flex ">
							<input type="checkbox" />
			...
			<div className="w-[768px] m-auto top-0 left-0">
				<div className="mt-[12px] px-[20px] py-[12px]  bg-white ">
					<div className="">
			...
			<div className=" h-[110px] shadow-inner">
				<div className="w-[768px] m-auto top-0 left-0">
