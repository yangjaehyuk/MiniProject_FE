	...
	return (
		<>
			...
			<div className="w-[screen] bg-pink-200">
				{/* 예약 숙소 정보 */}
				<div className="w-[screen] bg-pink-200">
					<div className="mt-[108px]  py-[12px]  bg-white ">
						<div className="">
					...
					<div className="mt-[12px] px-[20px] py-[400px]  bg-white ">
						...
						<div className=" text-sm text-text ">
							...
							<ul className="flex flex-col text-xxsm leading-5 text-textGray">
								<li>
									. 장바구니에 담긴 상품은 최대 30일간 보관되며 최대 20개의
									상품을 담을 수 있습니다.
								</li>
								...
								<li>
									기차와 국내숙소를 묶음예약하면, 일부 상품만 취소할 수 없고
									전체 취소만 가능합니다.
								</li>
							</ul>
						</div>
