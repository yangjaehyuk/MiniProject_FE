    ...
    <div className='flex py-5 justify-between border-b border-borderGray cursor-pointer'>
        ...
        <div className='p-4 w-[386px] h-fit border-borderGray border rounded-lg'>
            <div className ='flex text-sm justify-between '>
                <span className='text-footerTextGray font-semibold'>숙박</span>
            ...
            <div>
                <p className='text-sm text-footerTextGray py-1'>체크인 <span className='font-semibold'>15:00</span> ~ 체크아웃 <span className='font-semibold'>15:00</span></p>
            </div>
            <div className='flex flex-col items-end'>
            <p className='text-title font-bold text-soldOut'>76,200원</p>
            <p className='font-bold text-textGray text-content'>예약마감</p>
            </div>
